...
public class BaseActivity extends Activity {
	...
	protected void openActivity(Class<?> pClass) {
		// Class<?> 表示这个Class可以放任意的类,?表示object
	...
	protected AlertDialog showAlertDialog(String pTitle, String pMessage,
		...
		mAlertDialog = new AlertDialog.Builder(this).setTitle(pTitle)
				.setMessage(pMessage)
				.setPositiveButton(pPositiveButtonLabel, pOkClickListener)// 确定按钮
				.setNegativeButton(pNegativeButtonLabel, pCancelClickListener)// 取消按钮
				.show();
		if (pDismissListener != null) {
			mAlertDialog.setOnDismissListener(pDismissListener);// AlertDialog关闭事件
		}
		return mAlertDialog;
	}
	...
	public void finish() {
		super.finish();
		overridePendingTransition(R.anim.push_right_in, R.anim.push_right_out);// Activity切换效果（overridePendingTransition）
	}
